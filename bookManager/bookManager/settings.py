...
MIDDLEWARE = [
    ...
    'book.middlewares.Test2Middleware',
    # 'book.middlewares.Test3Middleware',
    'book.middlewares.Test4Middleware',
    'book.middlewares.Test5Middleware',
    'book.middlewares.Test6Middleware',
    # 'book.middlewares.Test7Middleware',
]
